/* clarity-js v0.7.47: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
            ...
            return rt(this, (function(Y) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 26:
                        ...
                        break;
                    case 27:
                        for (g = 0, b = Ue; g < b.length; g++) W = b[g], w = Ba(W.data.target, W.event, W.data.value), (a = [W.time, W.event]).push(w.id), a.push(m(W.data.value, "input", w.privacy, !1, W.data.type)), sr(a);
                        Be();
                        break;
                    case 21:
